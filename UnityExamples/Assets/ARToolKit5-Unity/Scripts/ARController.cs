...
//	}
	...
	public bool UseVideoBackground
	{
		...
		set
		{
			currentUseVideoBackground = false;
//			Vector3 hide = new Vector3 (999, 999, 999);
//			Debug.Log ("J# - UseVideoBackground( " + currentUseVideoBackground + " )" );
...
//				_videoBackgroundCamera0.transform.position = hide;
//				_videoBackgroundCamera0.enabled = currentUseVideoBackground;
//			}
//
//			if (_videoBackgroundCamera1 != null) {
//				_videoBackgroundCamera1.transform.position = hide;
