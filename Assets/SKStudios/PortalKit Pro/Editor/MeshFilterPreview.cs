            ...
            if (Event.current.type == EventType.Repaint) {
                if (TargetMeshRenderer == null) {
                   ...
                   */
                    ...
                    _previewRenderUtility.m_Camera.transform.position =(targetTransform.position - targetTransform.forward * 0.6f) - targetTransform.up * 0.3f + targetTransform.forward * 0.4f;
                    
                    _previewRenderUtility.m_Camera.farClipPlane = 1000;
                    _previewRenderUtility.m_Camera.fieldOfView = 20f;
                   _previewRenderUtility.m_Camera.ResetProjectionMatrix();

                    _previewRenderUtility.m_Camera.transform.rotation =
