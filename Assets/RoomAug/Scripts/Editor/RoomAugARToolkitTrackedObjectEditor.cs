...
[CustomEditor(typeof(RoomAugARToolkitTrackedObject))] 
public class RoomAugARToolkitTrackedObjectEditor : Editor 
{
    public override void OnInspectorGUI()
    {
		RoomAugARToolkitTrackedObject arto = (RoomAugARToolkitTrackedObject)target;
		if (arto == null) return;
